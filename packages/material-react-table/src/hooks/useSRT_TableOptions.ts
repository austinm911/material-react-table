...
import { SRT_AggregationFns } from '../fns/aggregationFns.shadcn'
import { SRT_FilterFns } from '../fns/filterFns.shadcn'
import { SRT_SortingFns } from '../fns/sortingFns.shadcn'
...
export const useSRT_TableOptions: <TData extends SRT_RowData>(
	...
	shadcnTheme = useMemo(() => getSRTTheme(shadcnTheme, theme), [shadcnTheme, theme])
	aggregationFns = useMemo(() => ({ ...SRT_AggregationFns, ...aggregationFns }), [])
	filterFns = useMemo(() => ({ ...SRT_FilterFns, ...filterFns }), [])
	sortingFns = useMemo(() => ({ ...SRT_SortingFns, ...sortingFns }), [])
	defaultColumn = useMemo(() => ({ ...SRT_DefaultColumn, ...defaultColumn }), [defaultColumn])
