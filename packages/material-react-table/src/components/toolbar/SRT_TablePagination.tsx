...
export interface SRT_TablePaginationProps<TData extends MRT_RowData>
	extends Partial<
		PaginationProps & {
...
export const SRT_TablePagination = <TData extends MRT_RowData>({
	position = "bottom",
	table,
	...rest
		...
		>
			{showRowsPerPage && (
				<Box sx={{ alignItems: "center", display: "flex", gap: "8px" }}>
					<InputLabel htmlFor={`srt-rows-per-page-${id}`} sx={{ mb: 0 }}>
