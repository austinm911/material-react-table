...
export interface SRT_TableBodyRowProps<TData extends MRT_RowData>
...
export const SRT_TableBodyRow = <TData extends MRT_RowData>({
	columnVirtualizer,
	numRows,
	pinnedRowIds,
	row,
	...
	const customRowHeight =
		// @ts-expect-error
		Number.parseInt(tableRowProps?.style?.height ?? sx?.height, 10) ||
		undefined;
