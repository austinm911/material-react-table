...
export const getColumnId = <TData extends SRT_RowData>(columnDef: SRT_ColumnDef<TData>): string =>
	...
	return columnDefs.map((columnDef) => {
		...
		if (columnDef.columns?.length) {
			...
			if (Object.keys(filterFns).includes(columnFilterFns[columnDef.id])) {
				...
				;(columnDef as SRT_DefinedColumnDef<TData>)._filterFn = columnFilterFns[columnDef.id]
			}
